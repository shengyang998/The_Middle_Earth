...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/MessageListener/MessageListener.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/TanImagePicker/TanImagePicker.framework"
